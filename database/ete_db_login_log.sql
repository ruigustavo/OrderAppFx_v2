...
DROP TABLE IF EXISTS `Workers_Log`;
...
--
-- Dumping data for table `Workers_Log`
--

LOCK TABLES `Workers_Log` WRITE;
/*!40000 ALTER TABLE `Workers_Log` DISABLE KEYS */;
/*!40000 ALTER TABLE `Workers_Log` ENABLE KEYS */;
UNLOCK TABLES;
